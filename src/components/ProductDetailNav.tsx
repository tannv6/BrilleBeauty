    ...
    return (
        <>
            <div className="flex justify-center">
                ...
                <Link href="#product_rvw" className={`flex items-center font-bold border border-l-0 justify-center w-[300px] h-14 ${(tab==2) ? "bg-[#ef426f] text-[#ffffff] border-0" : ""}`}>Product review(36)</Link>
