            ...
            <div className='py-[65px]'>
                <div className="inner-container flex justify-between">
                    <div className='flex gap-[75px]'>
                        ...
                        <div>
                            <p className='text-[15px] text-[#999] leading-6'>63 Sogong-ro, Jung-gu, Seoul, (Chungmuro ​​1-ga)</p>
                            <p className='text-[15px] text-[#999] leading-6'>Phone number : 070-8019-3362</p>
                            <p className='text-[15px] text-[#999] leading-6'>Mail order business report: Beauty0456@gmail.com</p>
                            <p className='text-[15px] text-[#999] leading-6 mt-[35px]'>Copyright ⓒ 2023 juntile., Ltd. All rights reserved.</p>
                        </div>
                    </div>
                    <div>
                        <p className='text-[18px] font-bold text-[#454545] leading-6'>Subscribe To Our Newsletter</p>
