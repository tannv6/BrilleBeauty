...
export default async function handle(
  ...
  try {
    ...
    const query = `select c1.*, p1.ProductName, p1.ProductImage, c2.ComboName, c2.ComboImage, p1.SellPrice as PriceProduct, 
                          c2.SellPrice AS PriceCombo, p2.PoName, p2.PoSellPrice, p3.PotName from cart as c1 
            ...
            left join combo as c2 on c1.ComboID = c2.ComboID
