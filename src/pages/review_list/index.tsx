        ...
        <div id="main">
          ...
          <div className="inner-container mt-[50px]">
            <div className="flex justify-between items-center mb-10">
              ...
              <input type="text" className="border w-[320px] h-[52px] rounded-md pl-5 pr-12 placeholder:text-base outline-none focus:ring-1 focus:ring-f04b76 bg-no-repeat bg-[center_right_1rem] bg-[url('/search_item_ico.png')]" placeholder="Please enter your search term." />
            </div>
